...
@Tag(name = "museum-owner-artifact-controller")
public class MuseumArtifactController {
    private final MuseumArtifactService museumArtifactService;
    ...
    public ResponseEntity<ApiResponse<MuseumArtifact>> addMuseumArtifactByZoneId(
        ...
        MuseumArtifact museumArtifactByZoneId = museumArtifactService.createMuseumArtifactByZoneId(museumArtifactRequest, zoneId);
    ...
    public ResponseEntity<ApiResponse<MuseumArtifact>> updateMuseumArtifactByArtifactId(
        ...
        museumArtifactService.updateMuseumArtifactByArtifactId(artifactId, museumArtifactRequest);
